...
<div style="max-width:640px">
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px">
        ...
        <h2 style="font-size:20px;font-weight:600;color:#111827;margin:0">Nuevo Cliente</h2>
    </div>
        ...
        <form method="POST" action="{{ route('clientes.store') }}">
            ...
            <div style="margin-bottom:24px">
                ...
                <textarea name="direccion" rows="2"
                          style="width:100%;border:1px solid #d1d5db;border-radius:8px;
                                 padding:8px 12px;font-size:14px;box-sizing:border-box;resize:vertical">{{ old('direccion') }}</textarea>
            </div>
